...
load Variables_names_m_by_n_lattice_2.mat
load Variables_names_unit_cell_2.mat
...
% U0_entire(p_entire_movable)=U0_entire_movable;
Force_entire=K_entire*U_entire;  

Force=norm(Force_entire(p_entire_movable2));
