...
%             hold on;plot(X_unit(4:7),Y_unit(4:7),'b-','linewidth',0.8);
%         elseif i==n+1           
%             hold on;fill(X_unit(1:4),Y_unit(1:4),'r')
%             hold on;plot(X_unit(1:4),Y_unit(1:4),'r-','linewidth',0.8);
%         else
%             hold on;fill(X_unit(1:4),Y_unit(1:4),'r')
%             hold on;plot(X_unit(1:4),Y_unit(1:4),'r-','linewidth',0.8);
%             hold on;fill(X_unit(4:7),Y_unit(4:7),'b')
%             hold on;plot(X_unit(4:7),Y_unit(4:7),'b-','linewidth',0.8);
% %             hold on;plot(X_unit(8:9),Y_unit(8:9),'k-','linewidth',1.5)
%         end
%     end
% end
rotation180=[cos(pi),-sin(pi);
...
save('Coor_hexagon.mat','Coor_unit_cell_x','Coor_unit_cell_y','alpha','gamma','theta') 
